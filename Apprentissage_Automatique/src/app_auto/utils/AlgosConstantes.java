...
public class AlgosConstantes {
    ...
    public final static String RDN_OPTIONS = "-L 0.5 -M 0.2 -N 500 -V 20 -S 0 -E 20 -H 300";
    public final static int NB_PART = 8;
    public final static int NB_ENTREE = NB_PART*8;
