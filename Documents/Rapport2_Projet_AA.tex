...
\begin{center}
	...
	\begin{tabular}{|p{7cm}|p{1cm}|p{7cm}|p{2cm}|p{2cm}|p{7cm}|}
		...
		\hline
		kppv avec matrice & 7/02 & Utilisation des distances  Euclidienne, Manhattan, Chebyshev. Possibilité de paramétrer le nombre de voisin (3, 5 ou 7) & 4h & 4h & L'algorithme de kppv est plus efficace avec la distance de Chebyshev. \\
		\hline
		...
		\hline
		Rapport d'avancement $n^o 2$ & 16/02 & En cours. & 1h & 20min & \\
		\hline
		\rowcolor{gris} & & & & & \\
		\hline
